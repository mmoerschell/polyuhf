...
\begin{itemize}
    ...
    \item We generate a small benchmarking harness for compiled hash functions, and conduct experiments to identify promising designs.
    \item Last but not least, we present a performance model for Apple Silicon ARM NEON chips, which automatically derives a runtime estimate from the IR of any DSL module.
\end{itemize}
