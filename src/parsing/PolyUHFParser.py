...
def serializedATN():
    return [
        ...
        0,0,0,2,3,6,0,-1,0,3,4,5,1,0,0,4,5,3,0,0,0,5,6,5,2,0,0,6,9,1,0,0,
        0,7,9,5,5,0,0,8,2,1,0,0,0,8,7,1,0,0,0,9,18,1,0,0,0,10,11,10,3,0,
        0,11,12,5,3,0,0,12,17,3,0,0,4,13,14,10,2,0,0,14,15,5,4,0,0,15,17,
...
class PolyUHFParser ( Parser ):
    ...
    def expr(self, _p:int=0):
        ...
        localctx = PolyUHFParser.ExprContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 0
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = PolyUHFParser.ExprContext(self, _parentctx, _parentState)
